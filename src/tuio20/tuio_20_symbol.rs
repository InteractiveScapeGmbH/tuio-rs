...
impl Tuio20Symbol {
    pub fn new(start_time: TuioTime, container: Tuio20Object, type_user_id: i32, component_id: i32, group: String, data: String) -> Self{
        Self{
    ...
    pub fn has_changed(&self, type_user_id: i32, component_id: i32, group: String, data: String) -> bool{
        !(self.type_user_id == type_user_id && self.component_id == component_id)
    }

    pub fn update(&mut self, current_time: TuioTime, type_user_id: i32, component_id: i32, group: String, data: String){
