...
impl Tuio20Token {
    pub fn new(start_time: TuioTime, container: Tuio20Object, type_user_id: u32, component_id: u32, position: Vector2D, angle: f32, velocity: Vector2D, rotation_speed: f32, acceleration: f32, rotation_acceleration: f32) -> Self{
        Self{
    ...
    pub fn update(&mut self, current_time: TuioTime, type_user_id: u32, component_id: u32, position: Vector2D, angle: f32, velocity: Vector2D, rotation_speed: f32, acceleration: f32, rotation_acceleration: f32){
